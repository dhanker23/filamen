...
class LokasiPolicy
{
    ...
    {
        return $user->can('force_delete_lokasi');
    }
    ...
    {
        return $user->can('force_delete_any_lokasi');
    }
    ...
    {
        return $user->can('restore_lokasi');
    }
    ...
    {
        return $user->can('restore_any_lokasi');
    }
    ...
    {
        return $user->can('replicate_lokasi');
    }
    ...
    {
        return $user->can('reorder_lokasi');
    }
}
